  ...
  <NavBar>
    ...
    <div class="relative flex flex-col items-center min-h-screen bg-center ">
      ...
      <section
        ...
        <h1 class="text-4xl">Benvenuto</h1>
        <p class="text-xl text-gray-500 mt-2 mb-6">Candidati ora per diventare uno sviluppatore di BitBoss</p>
        <button class="bg-blue-500 rounded-md text-white p-2">Candidati</button>
      </section>

      <section class="w-full pl-14 pt-4  selection:bg-red-500 selection:text-white">
